...
class igApi {
    ...
    constructor(IgCookie = '', storeCookie = true) {
        ...
        this.fetchPost = (url) => __awaiter(this, void 0, void 0, function* () {
            var _b;
            if (!this.IgCookie)
                throw new Error('silahkan Set cookie login terlebih dahulu, lihat di dokumentasi https://github.com/bolaxd/insta-fetcher');
            ...
            const item = metadata.graphql.shortcode_media;
            console.log(item)
   //======== KODINGAN GIMENZ =============\\
           /* return {
   ...
   //========== KODINGAN GWEH BOLAXD ==========//
            return {
               nama_ig: item.owner.username,
               jumlah_foll: item.owner.edge_followed_by.count,
               like_post: item.edge_media_preview_like.count,
               comment_post: item.edge_media_preview_comment.count,
               tumbnail_post: item.display_url,
               mime_type: item.is_video? 'video' : 'image',
               media_post: item.is_video? item.video_url : item.display_url
            }
        });
   ...
   //=========== FIX IG STALK BY bolaxd ===========//
        this.fetchUser = (username) => __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                    ...
                    post_count: graphql.user.edge_owner_to_timeline_media.count,
                    is_private: graphql.user.is_private,
                    is_verified: graphql.user.is_verified,
                    biography: graphql.user.biography,
                    external_url: graphql.user.external_url,
                    profil_thumb: graphql.user.profile_pic_url_hd,
                    contact_phone_number: graphql.user.business_phone_number,
                    public_email: graphql.user.business_email,
                    category_user: graphql.user.business_category_name,
                };
        });
        /**
        ...
        this.isFollowMe = (username) => __awaiter(this, void 0, void 0, function* () {
            const user = yield this.fetchUser(username);
            return user
        });
        /**
         *
